...
// node_modules/webgl-fluid/dist/webgl-fluid.mjs
(function(V, _) {
  typeof exports == "object" && typeof module < "u" ? _(exports) : typeof define == "function" && define.amd ? define(["exports"], _) : _(V.dat = {});
})(globalThis, function(V) {
  function _(e, t) {
    var i = e.__state.conversionName.toString(), r = Math.round(e.r), u = Math.round(e.g), c = Math.round(e.b), h = e.a, g = Math.round(e.h), b = e.s.toFixed(1), v = e.v.toFixed(1);
    if (t || i === "THREE_CHAR_HEX" || i === "SIX_CHAR_HEX") {
      for (var S = e.hex.toString(16); S.length < 6; )
        S = "0" + S;
      return "#" + S;
    }
    return i === "CSS_RGB" ? "rgb(" + r + "," + u + "," + c + ")" : i === "CSS_RGBA" ? "rgba(" + r + "," + u + "," + c + "," + h + ")" : i === "HEX" ? "0x" + e.hex.toString(16) : i === "RGB_ARRAY" ? "[" + r + "," + u + "," + c + "]" : i === "RGBA_ARRAY" ? "[" + r + "," + u + "," + c + "," + h + "]" : i === "RGB_OBJ" ? "{r:" + r + ",g:" + u + ",b:" + c + "}" : i === "RGBA_OBJ" ? "{r:" + r + ",g:" + u + ",b:" + c + ",a:" + h + "}" : i === "HSV_OBJ" ? "{h:" + g + ",s:" + b + ",v:" + v + "}" : i === "HSVA_OBJ" ? "{h:" + g + ",s:" + b + ",v:" + v + ",a:" + h + "}" : "unknown format";
  }
  function D(e, t, i) {
    Object.defineProperty(e, t, { get: function() {
      return this.__state.space === "RGB" ? this.__state[t] : (y.recalculateRGB(this, t, i), this.__state[t]);
    }, set: function(r) {
      this.__state.space !== "RGB" && (y.recalculateRGB(this, t, i), this.__state.space = "RGB"), this.__state[t] = r;
    } });
  }
  function he(e, t) {
    Object.defineProperty(e, t, { get: function() {
      return this.__state.space === "HSV" ? this.__state[t] : (y.recalculateHSV(this), this.__state[t]);
    }, set: function(i) {
      this.__state.space !== "HSV" && (y.recalculateHSV(this), this.__state.space = "HSV"), this.__state[t] = i;
    } });
  }
  function U(e) {
  ...
  function P(e, t, i, r) {
    e.style.background = "", d.each(Ae, function(u) {
      e.style.cssText += "background: " + u + "linear-gradient(" + t + ", " + i + " 0%, " + r + " 100%); ";
    });
  }
  function Ke(e) {
  ...
  function Je(e, t, i) {
    if (i.__li = t, i.__gui = e, d.extend(i, { options: function(c) {
      ...
      var r = new le(i.object, i.property, { min: i.__min, max: i.__max, step: i.__step });
      ...
      }), l.addClass(t, "has-slider"), i.domElement.insertBefore(r.domElement, i.domElement.firstElementChild);
      ...
      })) : i instanceof ge && (l.addClass(t, "color"), i.updateDisplay = d.compose(function(c) {
        return t.style.borderLeftColor = i.__color.toString(), c;
      }, i.updateDisplay), i.updateDisplay());
    i.setValue = d.compose(function(c) {
      return e.getRoot().__preset_select && i.isModified() && Oe(e.getRoot(), true), c;
    }, i.setValue);
  }
  function B(e, t) {
    ...
    if (r !== -1) {
      ...
      if (u === void 0 && (u = {}, i.__rememberedObjectIndecesToControllers[r] = u), u[t.property] = t, i.load && i.load.remembered) {
  ...
  function ae(e, t, i, r) {
    ...
    r.before instanceof x && (r.before = r.before.__li), B(e, u), l.addClass(u.domElement, "c");
    var h = document.createElement("span");
    l.addClass(h, "property-name"), h.innerHTML = u.property;
    var g = document.createElement("div");
    g.appendChild(h), g.appendChild(u.domElement);
    var b = G(e, g, r.before);
    return l.addClass(b, C.CLASS_CONTROLLER_ROW), u instanceof ge ? l.addClass(b, "color") : l.addClass(b, $e(u.getValue())), Je(e, b, u), e.__controllers.push(u), u;
  }
  function te(e, t) {
  ...
  function k(e) {
    ...
    if (e.load && e.load.remembered ? d.each(e.load.remembered, function(S, T) {
      F(e, T, T === e.preset);
    }) : F(e, I, false), l.bind(h, "change", function() {
      for (var S = 0; S < e.__preset_select.length; S++)
        e.__preset_select[S].innerHTML = e.__preset_select[S].value;
      e.preset = this.value;
    }), t.appendChild(h), t.appendChild(i), t.appendChild(r), t.appendChild(u), t.appendChild(c), oe) {
      var g = document.getElementById("dg-local-explain"), b = document.getElementById("dg-local-storage");
      document.getElementById("dg-save-locally").style.display = "block", localStorage.getItem(te(e, "isLocal")) === "true" && b.setAttribute("checked", "checked"), Pe(e, g), l.bind(b, "change", function() {
  ...
  function Qe(e) {
    function t(c) {
      return c.preventDefault(), e.width += u - c.clientX, e.onResize(), u = c.clientX, false;
    }
    function i() {
      l.removeClass(e.__closeButton, C.CLASS_DRAG), l.unbind(window, "mousemove", t), l.unbind(window, "mouseup", i);
    }
    function r(c) {
      return c.preventDefault(), u = c.clientX, l.addClass(e.__closeButton, C.CLASS_DRAG), l.bind(window, "mousemove", t), l.bind(window, "mouseup", i), false;
    }
    var u = void 0;
    e.__resize_handle = document.createElement("div"), d.extend(e.__resize_handle.style, { width: "6px", marginLeft: "-3px", height: "200px", cursor: "ew-resize", position: "absolute" }), l.bind(e.__resize_handle, "mousedown", r), l.bind(e.__closeButton, "mousedown", r), e.domElement.insertBefore(e.__resize_handle, e.domElement.firstElementChild);
  }
  function Le(e, t) {
  ...
  function ye(e, t) {
    var i = {};
    return d.each(e.__rememberedObjects, function(r, u) {
  ...
  var Me = Array.prototype.forEach, _e = Array.prototype.slice, d = { BREAK: {}, extend: function(e) {
    return this.each(_e.call(arguments, 1), function(t) {
    ...
    return function() {
      for (var t = _e.call(arguments), i = e.length - 1; i >= 0; i--)
        t = [e[i].apply(this, t)];
      return t[0];
    };
  }, each: function(e, t, i) {
  ...
  } }, Ze = [{ litmus: d.isString, conversions: { THREE_CHAR_HEX: { read: function(e) {
  ...
  } } } }], pe = void 0, Ee = void 0, Te = function() {
    Ee = false;
    var e = arguments.length > 1 ? d.toArray(arguments) : arguments[0];
    return d.each(Ze, function(t) {
      if (t.litmus(e))
        return d.each(t.conversions, function(i, r) {
          if (pe = i.read(e), Ee === false && pe !== false)
            return Ee = pe, pe.conversionName = r, pe.conversion = i, d.BREAK;
        }), d.BREAK;
    }), Ee;
  }, ze = void 0, ve = { hsv_to_rgb: function(e, t, i) {
    var r = Math.floor(e / 60) % 6, u = e / 60 - Math.floor(e / 60), c = i * (1 - t), h = i * (1 - u * t), g = i * (1 - (1 - u) * t), b = [[i, g, c], [h, i, c], [c, i, g], [c, h, i], [g, c, i], [i, c, h]][r];
    return { r: 255 * b[0], g: 255 * b[1], b: 255 * b[2] };
  }, rgb_to_hsv: function(e, t, i) {
    var r = Math.min(e, t, i), u = Math.max(e, t, i), c = u - r, h = void 0, g = void 0;
    ...
    function e() {
      if (M(this, e), this.__state = Te.apply(this, arguments), this.__state === false)
  ...
  y.recalculateRGB = function(e, t, i) {
    if (e.__state.space === "HEX")
      e.__state[t] = ve.component_from_hex(e.__state.hex, i);
    else {
      if (e.__state.space !== "HSV")
        throw new Error("Corrupted color state");
      d.extend(e.__state, ve.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v));
    }
  }, y.recalculateHSV = function(e) {
  ...
  }, y.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"], D(y.prototype, "r", 2), D(y.prototype, "g", 1), D(y.prototype, "b", 0), he(y.prototype, "h"), he(y.prototype, "s"), he(y.prototype, "v"), Object.defineProperty(y.prototype, "a", { get: function() {
    return this.__state.a;
  }, set: function(e) {
    this.__state.a = e;
  } }), Object.defineProperty(y.prototype, "hex", { get: function() {
    return !this.__state.space !== "HEX" && (this.__state.hex = ve.rgb_to_hex(this.r, this.g, this.b)), this.__state.hex;
  }, set: function(e) {
  ...
  }(), Ne = { HTMLEvents: ["change"], MouseEvents: ["click", "mousemove", "mousedown", "mouseup", "mouseover"], KeyboardEvents: ["keydown"] }, we = {};
  d.each(Ne, function(e, t) {
    d.each(e, function(i) {
      we[i] = t;
    });
  });
  var J = /(\d+(\.\d+)?)px/, l = { makeSelectable: function(e, t) {
    ...
    var r = i, u = t;
    d.isUndefined(u) && (u = true), d.isUndefined(r) && (r = true), e.style.position = "absolute", u && (e.style.left = 0, e.style.right = 0), r && (e.style.top = 0, e.style.bottom = 0);
    ...
    switch (c) {
      case "MouseEvents":
        ...
        h.initMouseEvent(t, u.bubbles || false, u.cancelable || true, window, u.clickCount || 1, 0, 0, g, b, false, false, false, false, 0, null);
        break;
      case "KeyboardEvents":
        var v = h.initKeyboardEvent || h.initKeyEvent;
        d.defaults(u, { cancelable: true, ctrlKey: false, altKey: false, shiftKey: false, metaKey: false, keyCode: void 0, charCode: void 0 }), v(t, u.bubbles || false, u.cancelable, window, u.ctrlKey, u.altKey, u.shiftKey, u.metaKey, u.keyCode, u.charCode);
        break;
      default:
        h.initEvent(t, u.bubbles || false, u.cancelable || true);
    }
    ...
    return U(t["border-left-width"]) + U(t["border-right-width"]) + U(t["padding-left"]) + U(t["padding-right"]) + U(t.width);
  }, getHeight: function(e) {
    var t = getComputedStyle(e);
    return U(t["border-top-width"]) + U(t["border-bottom-width"]) + U(t["padding-top"]) + U(t["padding-bottom"]) + U(t.height);
    ...
    function t(i, r) {
      M(this, t);
      var u = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)), c = u;
      return u.__prev = u.getValue(), u.__checkbox = document.createElement("input"), u.__checkbox.setAttribute("type", "checkbox"), l.bind(u.__checkbox, "change", function() {
        c.setValue(!c.__prev);
      }, false), u.domElement.appendChild(u.__checkbox), u.updateDisplay(), u;
    }
    return K(t, x), z(t, [{ key: "setValue", value: function(i) {
      var r = W(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setValue", this).call(this, i);
      return this.__onFinishChange && this.__onFinishChange.call(this, this.getValue()), this.__prev = this.getValue(), r;
    } }, { key: "updateDisplay", value: function() {
      return this.getValue() === true ? (this.__checkbox.setAttribute("checked", "checked"), this.__checkbox.checked = true, this.__prev = true) : (this.__checkbox.checked = false, this.__prev = false), W(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "updateDisplay", this).call(this);
    } }]), t;
  }(), Fe = function(e) {
    function t(i, r, u) {
      M(this, t);
      var c = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)), h = u, g = c;
    ...
    function t(i, r) {
      ...
      M(this, t);
      var c = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)), h = c;
    ...
    function t(i, r, u) {
      M(this, t);
      var c = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r)), h = u || {};
      return c.__min = h.min, c.__max = h.max, c.__step = h.step, d.isUndefined(c.__step) ? c.initialValue === 0 ? c.__impliedStep = 1 : c.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(c.initialValue)) / Math.LN10)) / 10 : c.__impliedStep = c.__step, c.__precision = me(c.__impliedStep), c;
    }
    return K(t, x), z(t, [{ key: "setValue", value: function(i) {
      var r = i;
      return this.__min !== void 0 && r < this.__min ? r = this.__min : this.__max !== void 0 && r > this.__max && (r = this.__max), this.__step !== void 0 && r % this.__step != 0 && (r = Math.round(r / this.__step) * this.__step), W(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setValue", this).call(this, r);
      ...
      return this.__step = i, this.__impliedStep = i, this.__precision = me(i), this;
    } }]), t;
  }(), le = function(e) {
    function t(i, r, u) {
      function c() {
      ...
      M(this, t);
      var b = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r, u));
      b.__truncationSuspended = false;
      var v = b, S = void 0;
      return b.__input = document.createElement("input"), b.__input.setAttribute("type", "text"), l.bind(b.__input, "change", function() {
        ...
        T.keyCode === 13 && (v.__truncationSuspended = true, this.blur(), v.__truncationSuspended = false, c());
      }), b.updateDisplay(), b.domElement.appendChild(b.__input), b;
    }
    return K(t, ie), z(t, [{ key: "updateDisplay", value: function() {
      return this.__input.value = this.__truncationSuspended ? this.getValue() : ee(this.getValue(), this.__precision), W(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "updateDisplay", this).call(this);
    } }]), t;
  }(), ue = function(e) {
    function t(i, r, u, c, h) {
      function g(R) {
        ...
        return m.setValue(n(R.clientX, q.left, q.right, m.__min, m.__max)), false;
      }
      function b() {
        l.unbind(window, "mousemove", g), l.unbind(window, "mouseup", b), m.__onFinishChange && m.__onFinishChange.call(m, m.getValue());
      }
      function v(R) {
        var q = R.touches[0].clientX, N = m.__background.getBoundingClientRect();
        m.setValue(n(q, N.left, N.right, m.__min, m.__max));
      }
      function S() {
        l.unbind(window, "touchmove", v), l.unbind(window, "touchend", S), m.__onFinishChange && m.__onFinishChange.call(m, m.getValue());
      }
      M(this, t);
      var T = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r, { min: u, max: c, step: h })), m = T;
    ...
    function t(i, r, u) {
      ...
      return c.__button = document.createElement("div"), c.__button.innerHTML = u === void 0 ? "Fire" : u, l.bind(c.__button, "click", function(g) {
        return g.preventDefault(), h.fire(), false;
    ...
    function t(i, r) {
      function u(N) {
        S(N), l.bind(window, "mousemove", S), l.bind(window, "touchmove", S), l.bind(window, "mouseup", h), l.bind(window, "touchend", h);
      }
      function c(N) {
        T(N), l.bind(window, "mousemove", T), l.bind(window, "touchmove", T), l.bind(window, "mouseup", g), l.bind(window, "touchend", g);
      }
      function h() {
      ...
      function b() {
        var N = Te(this.value);
        N !== false ? (R.__color.__state = N, R.setValue(R.__color.toOriginal())) : this.value = R.__color.toString();
      }
      function v() {
        R.__onFinishChange && R.__onFinishChange.call(R, R.__color.toOriginal());
      }
      function S(N) {
        N.type.indexOf("touch") === -1 && N.preventDefault();
        var X = R.__saturation_field.getBoundingClientRect(), Z = N.touches && N.touches[0] || N, et = Z.clientX, je = Z.clientY, fe = (et - X.left) / (X.right - X.left), xe = 1 - (je - X.top) / (X.bottom - X.top);
        return xe > 1 ? xe = 1 : xe < 0 && (xe = 0), fe > 1 ? fe = 1 : fe < 0 && (fe = 0), R.__color.v = xe, R.__color.s = fe, R.setValue(R.__color.toOriginal()), false;
      }
      function T(N) {
        N.type.indexOf("touch") === -1 && N.preventDefault();
        var X = R.__hue_field.getBoundingClientRect(), Z = 1 - ((N.touches && N.touches[0] || N).clientY - X.top) / (X.bottom - X.top);
        return Z > 1 ? Z = 1 : Z < 0 && (Z = 0), R.__color.h = 360 * Z, R.setValue(R.__color.toOriginal()), false;
      }
      M(this, t);
      var m = A(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, i, r));
      m.__color = new y(m.getValue()), m.__temp = new y(0);
      var R = m;
      m.domElement = document.createElement("div"), l.makeSelectable(m.domElement, false), m.__selector = document.createElement("div"), m.__selector.className = "selector", m.__saturation_field = document.createElement("div"), m.__saturation_field.className = "saturation-field", m.__field_knob = document.createElement("div"), m.__field_knob.className = "field-knob", m.__field_knob_border = "2px solid ", m.__hue_knob = document.createElement("div"), m.__hue_knob.className = "hue-knob", m.__hue_field = document.createElement("div"), m.__hue_field.className = "hue-field", m.__input = document.createElement("input"), m.__input.type = "text", m.__input_textShadow = "0 1px 1px ", l.bind(m.__input, "keydown", function(N) {
        N.keyCode === 13 && b.call(this);
    ...
    return K(t, x), z(t, [{ key: "updateDisplay", value: function() {
      var i = Te(this.getValue());
      if (i !== false) {
        var r = false;
        d.each(y.COMPONENTS, function(h) {
          if (!d.isUndefined(i[h]) && !d.isUndefined(this.__color.__state[h]) && i[h] !== this.__color.__state[h])
            return r = true, {};
        }, this), r && d.extend(this.__color.__state, i);
      }
  ...
  }(), Ae = ["-moz-", "-o-", "-webkit-", "-ms-", ""], be = { load: function(e, t) {
    ...
    return z(e, [{ key: "show", value: function() {
      ...
      var t = this, i = function r() {
        t.domElement.style.display = "none", t.backgroundElement.style.display = "none", l.unbind(t.domElement, "webkitTransitionEnd", r), l.unbind(t.domElement, "transitionend", r), l.unbind(t.domElement, "oTransitionEnd", r);
      };
...
`);
  be.inject(Q);
  var I = "Default", oe = function() {
    try {
      return !!window.localStorage;
    } catch {
      return false;
    }
  }(), ce = void 0, ne = true, Y = void 0, de = false, j = [], C = function e(t) {
    var i = this, r = t || {};
    this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), l.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], r = d.defaults(r, { closeOnTop: false, autoPlace: true, width: e.DEFAULT_WIDTH }), r = d.defaults(r, { resizable: r.autoPlace, hideable: r.autoPlace }), d.isUndefined(r.load) ? r.load = { preset: I } : r.preset && (r.load.preset = r.preset), d.isUndefined(r.parent) && r.hideable && j.push(this), r.resizable = d.isUndefined(r.parent) && r.resizable, r.autoPlace && d.isUndefined(r.scrollable) && (r.scrollable = true);
    var u = oe && localStorage.getItem(te(this, "isLocal")) === "true", c = void 0, h = void 0;
    if (Object.defineProperties(this, { parent: { get: function() {
      ...
      i.parent ? i.getRoot().preset = v : r.load.preset = v, qe(this), i.revert();
    } }, width: { get: function() {
      return r.width;
    }, set: function(v) {
      r.width = v, Le(i, v);
      ...
      r.closed = v, r.closed ? l.addClass(i.__ul, e.CLASS_CLOSED) : l.removeClass(i.__ul, e.CLASS_CLOSED), this.onResize(), i.__closeButton && (i.__closeButton.innerHTML = v ? e.TEXT_OPEN : e.TEXT_CLOSED);
    } }, load: { get: function() {
      return r.load;
    } }, useLocalStorage: { get: function() {
      return u;
    }, set: function(v) {
      oe && (u = v, v ? l.bind(window, "unload", c) : l.unbind(window, "unload", c), localStorage.setItem(te(i, "isLocal"), v));
    } } }), d.isUndefined(r.parent)) {
      if (r.closed = false, l.addClass(this.domElement, e.CLASS_MAIN), l.makeSelectable(this.domElement, false), oe && u) {
        i.useLocalStorage = true;
        var g = localStorage.getItem(te(this, "gui"));
        g && (r.load = JSON.parse(g));
      }
      this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = e.TEXT_CLOSED, l.addClass(this.__closeButton, e.CLASS_CLOSE_BUTTON), r.closeOnTop ? (l.addClass(this.__closeButton, e.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (l.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)), l.bind(this.__closeButton, "click", function() {
        i.closed = !i.closed;
      });
    } else {
      r.closed === void 0 && (r.closed = true);
      ...
      l.addClass(b, "controller-name"), h = G(i, b), l.addClass(this.__ul, e.CLASS_CLOSED), l.addClass(h, "title"), l.bind(h, "click", function(v) {
        return v.preventDefault(), i.closed = !i.closed, false;
      }), r.closed || (this.closed = false);
    }
    r.autoPlace && (d.isUndefined(r.parent) && (ne && (Y = document.createElement("div"), l.addClass(Y, "dg"), l.addClass(Y, e.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(Y), ne = false), Y.appendChild(this.domElement), l.addClass(this.domElement, e.CLASS_AUTO_PLACE)), this.parent || Le(i, r.width)), this.__resizeHandler = function() {
      i.onResizeDebounced();
    }, l.bind(window, "resize", this.__resizeHandler), l.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler), l.bind(this.__ul, "transitionend", this.__resizeHandler), l.bind(this.__ul, "oTransitionEnd", this.__resizeHandler), this.onResize(), r.resizable && Qe(this), c = function() {
      oe && localStorage.getItem(te(i, "isLocal")) === "true" && localStorage.setItem(te(i, "gui"), JSON.stringify(i.getSaveObject()));
    }, this.saveToLocalStorageIfPossible = c, r.parent || function() {
      var v = i.getRoot();
  ...
  C.toggleHide = function() {
  ...
  }, l.bind(window, "keydown", C._keydownHandler, false), d.extend(C.prototype, { add: function(e, t) {
    return ae(this, e, t, { factoryArgs: Array.prototype.slice.call(arguments, 2) });
  }, addColor: function(e, t) {
    return ae(this, e, t, { color: true });
  }, remove: function(e) {
    ...
    d.each(this.__folders, function(t) {
      e.removeFolder(t);
    }), l.unbind(window, "keydown", C._keydownHandler, false), ke(this);
    ...
    this.__ul.removeChild(e.domElement.parentElement), delete this.__folders[e.name], this.load && this.load.folders && this.load.folders[e.name] && delete this.load.folders[e.name], ke(e);
    var t = this;
    ...
    if (d.isUndefined(ce) && ((ce = new Be()).domElement.innerHTML = `<div id="dg-save" class="dg dialogue">
  ...
  <div id="dg-save-locally">
    ...
    d.each(Array.prototype.slice.call(arguments), function(t) {
      e.__rememberedObjects.length === 0 && k(e), e.__rememberedObjects.indexOf(t) === -1 && e.__rememberedObjects.push(t);
    ...
    var e = this.load;
    return e.closed = this.closed, this.__rememberedObjects.length > 0 && (e.preset = this.preset, e.remembered || (e.remembered = {}), e.remembered[this.preset] = ye(this)), e.folders = {}, d.each(this.__folders, function(t, i) {
      e.folders[i] = t.getSaveObject();
    }), e;
  }, save: function() {
    this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = ye(this), Oe(this, false), this.saveToLocalStorageIfPossible();
  }, saveAs: function(e) {
    this.load.remembered || (this.load.remembered = {}, this.load.remembered[I] = ye(this, true)), this.load.remembered[e] = ye(this), this.preset = e, F(this, e, true), this.saveToLocalStorageIfPossible();
  }, revert: function(e) {
    d.each(this.__controllers, function(t) {
      this.getRoot().load.remembered ? B(e || this.getRoot(), t) : t.setValue(t.initialValue), t.__onFinishChange && t.__onFinishChange.call(t, t.getValue());
    }, this), d.each(this.__folders, function(t) {
      t.revert(t);
    }), e || Oe(this.getRoot(), false);
  }, listen: function(e) {
  ...
  var Ge = { Color: y, math: ve, interpret: Te }, Xe = { Controller: x, BooleanController: se, OptionController: Fe, StringController: Ue, NumberController: ie, NumberControllerBox: le, NumberControllerSlider: ue, FunctionController: Se, ColorController: ge }, H = { dom: l }, Ce = { GUI: C }, Ve = C, Ye = { color: Ge, controllers: Xe, dom: H, gui: Ce, GUI: Ve };
  V.color = Ge, V.controllers = Xe, V.dom = H, V.gui = Ce, V.GUI = Ve, V.default = Ye, Object.defineProperty(V, "__esModule", { value: true });
});
function ft(V, _) {
  const D = V;
  g(), _ = {
  ...
  function he() {
    this.id = -1, this.texcoordX = 0, this.texcoordY = 0, this.prevTexcoordX = 0, this.prevTexcoordY = 0, this.deltaX = 0, this.deltaY = 0, this.down = false, this.moved = false, this.color = [30, 0, 300];
  }
  const U = [], me = [], ee = [];
  U.push(new he());
  const { gl: n, ext: P } = Ke(D);
  Oe() && (_.DYE_RESOLUTION = 512), P.supportLinearFiltering || (_.DYE_RESOLUTION = 512, _.SHADING = false, _.BLOOM = false, _.SUNRAYS = false);
  function Ke(o) {
    const s = { alpha: true, depth: false, stencil: false, antialias: false, preserveDrawingBuffer: false };
    let a = o.getContext("webgl2", s);
    const f = !!a;
    f || (a = o.getContext("webgl", s) || o.getContext("experimental-webgl", s));
    let p, w;
    f ? (a.getExtension("EXT_color_buffer_float"), w = a.getExtension("OES_texture_float_linear")) : (p = a.getExtension("OES_texture_half_float"), w = a.getExtension("OES_texture_half_float_linear")), a.clearColor(0, 0, 0, 1);
    const E = f ? a.HALF_FLOAT : p.HALF_FLOAT_OES;
    let L, O, re;
    return f ? (L = G(a, a.RGBA16F, a.RGBA, E), O = G(a, a.RG16F, a.RG, E), re = G(a, a.R16F, a.RED, E)) : (L = G(a, a.RGBA, a.RGBA, E), O = G(a, a.RGBA, a.RGBA, E), re = G(a, a.RGBA, a.RGBA, E)), {
      gl: a,
      ext: {
        formatRGBA: L,
        formatRG: O,
  ...
  function ke(o, s, a, f) {
    const p = o.createTexture();
    o.bindTexture(o.TEXTURE_2D, p), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MIN_FILTER, o.NEAREST), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_MAG_FILTER, o.NEAREST), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_S, o.CLAMP_TO_EDGE), o.texParameteri(o.TEXTURE_2D, o.TEXTURE_WRAP_T, o.CLAMP_TO_EDGE), o.texImage2D(o.TEXTURE_2D, 0, s, 4, 4, 0, a, f, null);
    const w = o.createFramebuffer();
    return o.bindFramebuffer(o.FRAMEBUFFER, w), o.framebufferTexture2D(o.FRAMEBUFFER, o.COLOR_ATTACHMENT0, o.TEXTURE_2D, p, 0), o.checkFramebufferStatus(o.FRAMEBUFFER) === o.FRAMEBUFFER_COMPLETE;
  }
  function Oe() {
  ...
  class Je {
    ...
    setKeywords(s) {
      ...
      if (!f) {
        const p = F(n.FRAGMENT_SHADER, this.fragmentShaderSource, s);
        f = ae(this.vertexShader, p), this.programs[a] = f;
      }
      f !== this.activeProgram && (this.uniforms = te(f), this.activeProgram = f);
    }
    bind() {
  ...
  class B {
    constructor(s, a) {
      this.uniforms = {}, this.program = ae(s, a), this.uniforms = te(this.program);
    }
    bind() {
  ...
  function te(o) {
    const s = [], a = n.getProgramParameter(o, n.ACTIVE_UNIFORMS);
    for (let f = 0; f < a; f++) {
      const p = n.getActiveUniform(o, f).name;
  ...
  function F(o, s, a) {
    ...
    if (n.shaderSource(f, s), n.compileShader(f), !n.getShaderParameter(f, n.COMPILE_STATUS))
...
`), Ie = F(n.FRAGMENT_SHADER, `
    precision mediump float;
    uniform vec4 color;
    void main () {
        gl_FragColor = color;
    }
`), Me = F(n.FRAGMENT_SHADER, _.TRANSPARENT ? `
    precision highp float;
...
`), ve = F(n.FRAGMENT_SHADER, `
    ...
    }`, P.supportLinearFiltering ? null : ["MANUAL_FILTERING"]), $e = F(n.FRAGMENT_SHADER, `
    precision mediump float;
    precision mediump sampler2D;
    varying highp vec2 vUv;
...
`), A = (() => (n.bindBuffer(n.ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ARRAY_BUFFER, new Float32Array([-1, -1, -1, 1, 1, 1, 1, -1]), n.STATIC_DRAW), n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), n.STATIC_DRAW), n.vertexAttribPointer(0, 2, n.FLOAT, false, 0, 0), n.enableVertexAttribArray(0), (o) => {
    n.bindFramebuffer(n.FRAMEBUFFER, o), n.drawElements(n.TRIANGLES, 6, n.UNSIGNED_SHORT, 0);
  }))();
  let y, x, Ne, we, J, l, se, Fe;
  const Ue = e(), ie = new B(Qe, Le), le = new B(k, ye), ue = new B(k, qe), Se = new B(k, Ie), ge = new B(k, Me), Ae = new B(k, d), be = new B(k, Ze), Re = new B(k, pe), He = new B(k, Ee), Be = new B(k, Te), Q = new B(k, ze), I = new B(k, ve), oe = new B(k, $e), ce = new B(k, M), ne = new B(k, z), Y = new B(k, W), de = new B(k, K), j = new Je(k, _e);
  function C() {
    const o = We(_.SIM_RESOLUTION), s = We(_.DYE_RESOLUTION), a = P.halfFloatTexType, f = P.formatRGBA, p = P.formatRG, w = P.formatR, E = P.supportLinearFiltering ? n.LINEAR : n.NEAREST;
    y ? y = Ye(y, s.width, s.height, f.internalFormat, f.format, a, E) : y = Ce(s.width, s.height, f.internalFormat, f.format, a, E), x ? x = Ye(x, o.width, o.height, p.internalFormat, p.format, a, E) : x = Ce(o.width, o.height, p.internalFormat, p.format, a, E), Ne = H(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST), we = H(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST), J = Ce(o.width, o.height, w.internalFormat, w.format, a, n.NEAREST), Ge(), Xe();
  }
  function Ge() {
    const o = We(_.BLOOM_RESOLUTION), s = P.halfFloatTexType, a = P.formatRGBA, f = P.supportLinearFiltering ? n.LINEAR : n.NEAREST;
    l = H(o.width, o.height, a.internalFormat, a.format, s, f), ee.length = 0;
    for (let p = 0; p < _.BLOOM_ITERATIONS; p++) {
      const w = o.width >> p + 1, E = o.height >> p + 1;
      if (w < 2 || E < 2)
        break;
      const L = H(w, E, a.internalFormat, a.format, s, f);
      ee.push(L);
    }
  }
  function Xe() {
    const o = We(_.SUNRAYS_RESOLUTION), s = P.halfFloatTexType, a = P.formatR, f = P.supportLinearFiltering ? n.LINEAR : n.NEAREST;
    se = H(o.width, o.height, a.internalFormat, a.format, s, f), Fe = H(o.width, o.height, a.internalFormat, a.format, s, f);
  }
  function H(o, s, a, f, p, w) {
    ...
    n.bindFramebuffer(n.FRAMEBUFFER, L), n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, E, 0), n.viewport(0, 0, o, s), n.clear(n.COLOR_BUFFER_BIT);
    const O = 1 / o, re = 1 / s;
    return {
      texture: E,
      fbo: L,
      ...
      texelSizeY: re,
      attach(De) {
        return n.activeTexture(n.TEXTURE0 + De), n.bindTexture(n.TEXTURE_2D, E), De;
      }
    };
  }
  function Ce(o, s, a, f, p, w) {
    let E = H(o, s, a, f, p, w), L = H(o, s, a, f, p, w);
    return {
      width: o,
      height: s,
      texelSizeX: E.texelSizeX,
      texelSizeY: E.texelSizeY,
      get read() {
        return E;
      },
      set read(O) {
  ...
  function Ve(o, s, a, f, p, w, E) {
    const L = H(s, a, f, p, w, E);
    return le.bind(), n.uniform1i(le.uniforms.uTexture, o.attach(0)), A(L.fbo), L;
  }
  function Ye(o, s, a, f, p, w, E) {
    return o.width === s && o.height === a || (o.read = Ve(o.read, s, a, f, p, w, E), o.write = H(s, a, f, p, w, E), o.width = s, o.height = a, o.texelSizeX = 1 / s, o.texelSizeY = 1 / a), o;
  }
  function e(o) {
    const s = n.createTexture();
    n.bindTexture(n.TEXTURE_2D, s), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.LINEAR), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MAG_FILTER, n.LINEAR), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.REPEAT), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.REPEAT), n.texImage2D(n.TEXTURE_2D, 0, n.RGB, 1, 1, 0, n.RGB, n.UNSIGNED_BYTE, new Uint8Array([255, 255, 255]));
    const a = {
      texture: s,
      width: 1,
      height: 1,
      attach(p) {
        return n.activeTexture(n.TEXTURE0 + p), n.bindTexture(n.TEXTURE_2D, s), p;
      }
    }, f = new Image();
    return f.onload = () => {
      a.width = f.width, a.height = f.height, n.bindTexture(n.TEXTURE_2D, s), n.texImage2D(n.TEXTURE_2D, 0, n.RGB, n.RGB, n.UNSIGNED_BYTE, f);
    }, o && (f.src = o), a;
  }
  function t() {
    const o = [];
  ...
  function i() {
    _.AUTO && _.INTERVAL && !_.PAUSED && me.push(_.SPLAT_COUNT), setTimeout(i, _.INTERVAL);
  }
  setTimeout(i, _.INTERVAL);
  let r = Date.now(), u = 0;
  c();
  function c() {
    const o = h();
    g() && C(), b(o), v(), _.PAUSED || S(o), T(null), requestAnimationFrame(c);
  }
  function h() {
    const o = Date.now();
    let s = (o - r) / 1e3;
    return s = Math.min(s, 0.016666), r = o, s;
  }
  function g() {
    const o = $(D.clientWidth), s = $(D.clientHeight);
    return D.width !== o || D.height !== s ? (D.width = o, D.height = s, true) : false;
  }
  function b(o) {
    _.COLORFUL && (u += o * _.COLOR_UPDATE_SPEED, u >= 1 && (u = ut(u, 0, 1), U.forEach((s) => {
      s.color = tt();
    })));
  }
  function v() {
    me.length > 0 && je(me.pop()), U.forEach((o) => {
      o.moved && (o.moved = false, et(o));
    });
  }
  function S(o) {
    n.disable(n.BLEND), n.viewport(0, 0, x.width, x.height), ce.bind(), n.uniform2f(ce.uniforms.texelSize, x.texelSizeX, x.texelSizeY), n.uniform1i(ce.uniforms.uVelocity, x.read.attach(0)), A(we.fbo), ne.bind(), n.uniform2f(ne.uniforms.texelSize, x.texelSizeX, x.texelSizeY), n.uniform1i(ne.uniforms.uVelocity, x.read.attach(0)), n.uniform1i(ne.uniforms.uCurl, we.attach(1)), n.uniform1f(ne.uniforms.curl, _.CURL), n.uniform1f(ne.uniforms.dt, o), A(x.write.fbo), x.swap(), oe.bind(), n.uniform2f(oe.uniforms.texelSize, x.texelSizeX, x.texelSizeY), n.uniform1i(oe.uniforms.uVelocity, x.read.attach(0)), A(Ne.fbo), ue.bind(), n.uniform1i(ue.uniforms.uTexture, J.read.attach(0)), n.uniform1f(ue.uniforms.value, _.PRESSURE), A(J.write.fbo), J.swap(), Y.bind(), n.uniform2f(Y.uniforms.texelSize, x.texelSizeX, x.texelSizeY), n.uniform1i(Y.uniforms.uDivergence, Ne.attach(0));
    for (let a = 0; a < _.PRESSURE_ITERATIONS; a++)
      n.uniform1i(Y.uniforms.uPressure, J.read.attach(1)), A(J.write.fbo), J.swap();
    de.bind(), n.uniform2f(de.uniforms.texelSize, x.texelSizeX, x.texelSizeY), n.uniform1i(de.uniforms.uPressure, J.read.attach(0)), n.uniform1i(de.uniforms.uVelocity, x.read.attach(1)), A(x.write.fbo), x.swap(), I.bind(), n.uniform2f(I.uniforms.texelSize, x.texelSizeX, x.texelSizeY), P.supportLinearFiltering || n.uniform2f(I.uniforms.dyeTexelSize, x.texelSizeX, x.texelSizeY);
    const s = x.read.attach(0);
    n.uniform1i(I.uniforms.uVelocity, s), n.uniform1i(I.uniforms.uSource, s), n.uniform1f(I.uniforms.dt, o), n.uniform1f(I.uniforms.dissipation, _.VELOCITY_DISSIPATION), A(x.write.fbo), x.swap(), n.viewport(0, 0, y.width, y.height), P.supportLinearFiltering || n.uniform2f(I.uniforms.dyeTexelSize, y.texelSizeX, y.texelSizeY), n.uniform1i(I.uniforms.uVelocity, x.read.attach(0)), n.uniform1i(I.uniforms.uSource, y.read.attach(1)), n.uniform1f(I.uniforms.dissipation, _.DENSITY_DISSIPATION), A(y.write.fbo), y.swap();
  }
  function T(o) {
    _.BLOOM && N(y.read, l), _.SUNRAYS && (X(y.read, y.write, se), Z(se, Fe, 1)), !o || !_.TRANSPARENT ? (n.blendFunc(n.ONE, n.ONE_MINUS_SRC_ALPHA), n.enable(n.BLEND)) : n.disable(n.BLEND);
    const s = o ? o.width : n.drawingBufferWidth, a = o ? o.height : n.drawingBufferHeight;
    n.viewport(0, 0, s, a);
    const f = o ? o.fbo : null;
    _.TRANSPARENT || m(f, lt(_.BACK_COLOR)), !o && _.TRANSPARENT && R(f), q(f, s, a);
  }
  function m(o, s) {
    Se.bind(), n.uniform4f(Se.uniforms.color, s.r, s.g, s.b, 1), A(o);
  }
  function R(o) {
    ge.bind(), n.uniform1f(ge.uniforms.aspectRatio, D.width / D.height), A(o);
  }
  function q(o, s, a) {
    if (j.bind(), _.SHADING && n.uniform2f(j.uniforms.texelSize, 1 / s, 1 / a), n.uniform1i(j.uniforms.uTexture, y.read.attach(0)), _.BLOOM) {
      n.uniform1i(j.uniforms.uBloom, l.attach(1)), n.uniform1i(j.uniforms.uDithering, Ue.attach(2));
      const f = ct(Ue, s, a);
      n.uniform2f(j.uniforms.ditherScale, f.x, f.y);
    }
    _.SUNRAYS && n.uniform1i(j.uniforms.uSunrays, se.attach(3)), A(o);
  }
  function N(o, s) {
    if (ee.length < 2)
      return;
    let a = s;
    n.disable(n.BLEND), Ae.bind();
    const f = _.BLOOM_THRESHOLD * _.BLOOM_SOFT_KNEE + 1e-4, p = _.BLOOM_THRESHOLD - f, w = f * 2, E = 0.25 / f;
    n.uniform3f(Ae.uniforms.curve, p, w, E), n.uniform1f(Ae.uniforms.threshold, _.BLOOM_THRESHOLD), n.uniform1i(Ae.uniforms.uTexture, o.attach(0)), n.viewport(0, 0, a.width, a.height), A(a.fbo), be.bind();
    for (let L = 0; L < ee.length; L++) {
      const O = ee[L];
      n.uniform2f(be.uniforms.texelSize, a.texelSizeX, a.texelSizeY), n.uniform1i(be.uniforms.uTexture, a.attach(0)), n.viewport(0, 0, O.width, O.height), A(O.fbo), a = O;
    }
    n.blendFunc(n.ONE, n.ONE), n.enable(n.BLEND);
    for (let L = ee.length - 2; L >= 0; L--) {
      const O = ee[L];
      n.uniform2f(be.uniforms.texelSize, a.texelSizeX, a.texelSizeY), n.uniform1i(be.uniforms.uTexture, a.attach(0)), n.viewport(0, 0, O.width, O.height), A(O.fbo), a = O;
    }
    n.disable(n.BLEND), Re.bind(), n.uniform2f(Re.uniforms.texelSize, a.texelSizeX, a.texelSizeY), n.uniform1i(Re.uniforms.uTexture, a.attach(0)), n.uniform1f(Re.uniforms.intensity, _.BLOOM_INTENSITY), n.viewport(0, 0, s.width, s.height), A(s.fbo);
  }
  function X(o, s, a) {
    n.disable(n.BLEND), He.bind(), n.uniform1i(He.uniforms.uTexture, o.attach(0)), n.viewport(0, 0, s.width, s.height), A(s.fbo), Be.bind(), n.uniform1f(Be.uniforms.weight, _.SUNRAYS_WEIGHT), n.uniform1i(Be.uniforms.uTexture, s.attach(0)), n.viewport(0, 0, a.width, a.height), A(a.fbo);
  }
  function Z(o, s, a) {
    ie.bind();
    for (let f = 0; f < a; f++)
      n.uniform2f(ie.uniforms.texelSize, o.texelSizeX, 0), n.uniform1i(ie.uniforms.uTexture, o.attach(0)), A(s.fbo), n.uniform2f(ie.uniforms.texelSize, 0, o.texelSizeY), n.uniform1i(ie.uniforms.uTexture, s.attach(0)), A(o.fbo);
  }
  function et(o) {
    const s = o.deltaX * _.SPLAT_FORCE, a = o.deltaY * _.SPLAT_FORCE;
    fe(o.texcoordX, o.texcoordY, s, a, o.color);
  }
  function je(o) {
    for (let s = 0; s < o; s++) {
      const a = tt();
      a.r *= 10, a.g *= 10, a.b *= 10;
      const f = Math.random(), p = Math.random(), w = 1e3 * (Math.random() - 0.5), E = 1e3 * (Math.random() - 0.5);
      fe(f, p, w, E, a);
    }
  }
  function fe(o, s, a, f, p) {
    n.viewport(0, 0, x.width, x.height), Q.bind(), n.uniform1i(Q.uniforms.uTarget, x.read.attach(0)), n.uniform1f(Q.uniforms.aspectRatio, D.width / D.height), n.uniform2f(Q.uniforms.point, o, s), n.uniform3f(Q.uniforms.color, a, f, 0), n.uniform1f(Q.uniforms.radius, xe(_.SPLAT_RADIUS / 100)), A(x.write.fbo), x.swap(), n.viewport(0, 0, y.width, y.height), n.uniform1i(Q.uniforms.uTarget, y.read.attach(0)), n.uniform3f(Q.uniforms.color, p.r, p.g, p.b), A(y.write.fbo), y.swap();
  }
  function xe(o) {
  ...
  D.addEventListener("mousedown", (o) => {
    const s = $(o.offsetX), a = $(o.offsetY);
    let f = U.find((p) => p.id === -1);
    f || (f = new he()), it(f, -1, s, a);
  }), setTimeout(() => {
    ...
    for (let a = 0; a < s.length; a++) {
      const f = $(s[a].pageX), p = $(s[a].pageY);
      it(U[a + 1], s[a].identifier, f, p);
    }
    ...
    for (let a = 0; a < s.length; a++) {
      const f = U.find((p) => p.id === s[a].identifier);
      nt(f);
    }
  }), window.addEventListener("keydown", (o) => {
    o.code === "KeyP" && (_.PAUSED = !_.PAUSED), o.key === " " && me.push(Number.parseInt(Math.random() * 20) + 5);
  });
  function it(o, s, a, f) {
    o.id = s, o.down = true, o.moved = false, o.texcoordX = a / D.width, o.texcoordY = 1 - f / D.height, o.prevTexcoordX = o.texcoordX, o.prevTexcoordY = o.texcoordY, o.deltaX = 0, o.deltaY = 0, o.color = tt();
  }
  function ot(o, s, a) {
    _.TRIGGER === "click" && (o.moved = o.down), o.prevTexcoordX = o.texcoordX, o.prevTexcoordY = o.texcoordY, o.texcoordX = s / D.width, o.texcoordY = 1 - a / D.height, o.deltaX = rt(o.texcoordX - o.prevTexcoordX), o.deltaY = at(o.texcoordY - o.prevTexcoordY), _.TRIGGER === "hover" && (o.moved = Math.abs(o.deltaX) > 0 || Math.abs(o.deltaY) > 0);
  }
  function nt(o) {
    o.down = false;
  }
  ...
  function st(o, s, a) {
    let f, p, w;
    const E = Math.floor(o * 6), L = o * 6 - E, O = a * (1 - s), re = a * (1 - L * s), De = a * (1 - (1 - L) * s);
    switch (E % 6) {
      case 0:
        f = a, p = De, w = O;
        break;
  ...
  function We(o) {
    ...
    s < 1 && (s = 1 / s);
    const a = Math.round(o), f = Math.round(o * s);
    return n.drawingBufferWidth > n.drawingBufferHeight ? { width: f, height: a } : { width: a, height: f };
  }
  function ct(o, s, a) {
    return {
      x: s / o.width,
...
//# sourceMappingURL=webgl-fluid.js.map
