...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react17.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react17.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react17.useCallback)((...args) => {
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react18.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react19.useRef)(modifiers);
  const popperInstanceRef = (0, import_react19.useRef)();
  const update = (0, import_react19.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react19.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react19.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react19.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react19.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  const preventMouseClickOutsideRef = (0, import_react20.useRef)(false);
  const waitingForTrigger = (0, import_react20.useRef)(false);
  const handleMouseCapture = (0, import_react20.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react21.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react21.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react22.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react22.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react22.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react22.useState)(true);
  let value = (0, import_react22.useMemo)(() => ({
  ...
  return (0, import_react22.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react22.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react22.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react22.default).createElement((0, import_react22.default).Fragment, null, props.children);
  }
  return (0, import_react22.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react22.useContext)($b5e257d569688ac6$var$SSRContext);
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, import_react22.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react22.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react22.default)["useSyncExternalStore"] === "function") return (0, import_react22.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react22.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react23.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react23.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
var Context = (0, import_react25.createContext)(canUseDOM_default ? window : void 0);
...
function getReactVersion() {
  const parts = React79.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var Modal2 = React90.forwardRef(({
  ...
  const renderBackdrop = (0, import_react46.useCallback)((backdropProps) => (0, import_jsx_runtime87.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React98.forwardRef(({
  ...
  const renderBackdrop = (0, import_react51.useCallback)((backdropProps) => (0, import_jsx_runtime95.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime112.jsxs)(import_jsx_runtime111.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react58.cloneElement)(children, triggerProps), (0, import_jsx_runtime110.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
